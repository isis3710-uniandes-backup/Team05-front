    ...
    <div className='form-card'>
      <div className='checkmark-wrapper'>
        <svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xlink='http://www.w3.org/1999/xlink'
          x='0px' y='0px' viewBox='0 0 98.5 98.5' enableBackground='new 0 0 98.5 98.5' xml='preserve' space='preserve'>
          <path className='checkmark' fill='none' strokeWidth='6' strokeMiterlimit='10'
